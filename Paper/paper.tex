...
As shown in Figure~\ref{fig:beam_diffuse}, our engine is able to distinguish between direct beam irradiance and diffuse ambient skylight. This confirms that our geometric occlusion successfully filters out the direct beam stress and leaves the asset exposed predominantly to Perez diffuse skylight.
