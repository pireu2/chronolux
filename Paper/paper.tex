...
\begin{figure}[htbp]
\centerline{\includegraphics[width=0.9\columnwidth]{fig5_beam_vs_diffuse.png}}
\caption{Decomposition of light dosimetry shows effective separation of direct solar beam from diffuse Perez ambient skylight using our Next Event Estimation algorithm.}
\label{fig:beam_diffuse}
\end{figure}

As shown in Figure~\ref{fig:beam_diffuse}, our engine is able to distinguish between direct beam irradiance and diffuse ambient skylight. This confirms that our geometric occlusion successfully filters out the direct beam stress and leaves the asset exposed only to Perez diffuse skylight.
