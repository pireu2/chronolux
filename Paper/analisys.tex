...
The model uses five empirically obtained static coefficients to shape the anisotropic properties of the sky dome. For a clear sky scenario with Turbidity $T = 2.0$, these thermodynamic parameters are typically defined as:
\begin{itemize}
