...
\label{apx:scientific_paper}

The following pages reproduce the scientific paper titled "\textit{Real-Time Light Dosimetry for Heritage Digital Twins via Texture Space Ray Tracing}" in its entirety. This paper was submitted to the 2026 IEEE 22nd International Conference on Intelligent Computer Communication and Processing (ICCP 2026), which will be held in October 2026 in Cluj-Napoca, Romania.

\includepdf[pages=-,scale=0.85,pagecommand={\thispagestyle{fancy}}]{paper.pdf}
