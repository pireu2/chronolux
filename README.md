...
- **Heatmap Visualization:** High-performance HDRP surface shader maps the raw Float32 Lux-Hour data into an "Inferno" (Purple-Red-Yellow) gradient. This enables curators to instantly identify microscopic high-risk exposure hotspots.
